...
umount -R /mnt/*;
echo "##########################################################################################################################
//192.168.0.3/Download /mnt/Download cifs uid=root,gid=sudo,file_mode=0775,dir_mode=0777,username=marc,password=admin 0 0
...
deny_file={*.exe,*.sh,.private} 
allow_file={*.mkv,*.mp3,*.rar}
#
########################################################################

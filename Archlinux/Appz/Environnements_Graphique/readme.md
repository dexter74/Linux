...
#### Profil XFCE
```
runuser -l marc -c 'wget "https://github.com/dexter74/Linux/raw/main/Archlinux/Appz/Environnements_Graphique/Bureau/XFCE4_Profile.tar.bz2" -O /home/marc/Telechargement/XFCE4_Profile.tar.bz2'
```
